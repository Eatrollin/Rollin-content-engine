...
const PERF_HISTORY_PATH     = path.join(DATA_DIR, 'performance-history.json');
const APPROVAL_HISTORY_PATH = path.join(DATA_DIR, 'approval-history.json');
...
async function run() {
  ...
  await fse.ensureDir(path.dirname(PERF_HISTORY_PATH));
